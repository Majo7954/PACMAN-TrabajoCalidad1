...
// Función de movimiento genérica
...
var GF = function(){
    ...
    // Función común para mover personajes
    function createCharacterMovementClass(ghost = false) {
        return function() {
            ...
            this.nearestCol = 0;
            this.ctx = ctx;
            this.id = ghost ? 0 : undefined; // ghost id is zero for simplicity
            this.homeX = 0;
            this.homeY = 0;
    ...
    // Crear instancias de Pacman y Ghosts usando la clase genérica de movimiento
